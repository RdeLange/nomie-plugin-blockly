...
function createSvelteAnchorMissingAttributeQuickfixAction(textDocument, transpiled, content, lineOffsets, node) {
    ...
    const targetAttributePosition = (0, documents_1.positionAt)(targetAttribute.end, content, lineOffsets);
    const relNoReferrerTextEdit = vscode_languageserver_1.TextEdit.insert(targetAttributePosition, ' rel="noreferrer"');
    return vscode_languageserver_1.CodeAction.create('(svelte) Add missing attribute rel="noreferrer"', {
        documentChanges: [
            vscode_languageserver_1.TextDocumentEdit.create(textDocument, [
                (0, documents_1.mapObjWithRangeToOriginal)(transpiled, relNoReferrerTextEdit)
            ])
        ]
